...
The repository and GitHub Pages website are public. All couple artwork in `docs/` is generated illustration; the original reference photos are not included in this repository or its history. The earlier working repository remains private.
